...
nextTabunganList = function()
{
    ...
    $.ajax({
        ...
        data: "page="+pageList+"&nis="+nis+"&idtahunbuku="+idtahunbuku+"&idtabungan="+idtabungan,
...
{	
	if (validasiSetoran()) 
	{
		...
		var addr = "tabungan.trans.input.php?op=348328947234923&idtabungan="+idtabungan+"&nis="+nis+"&idtahunbuku="+idtahunbuku+"&jsetor="+jsetor+"&keterangan="+keterangan+"&rekkas="+rekkas;
...
{	
	if (validasiTarikan()) 
	{
		...
		var addr = "tabungan.trans.input.php?op=348328947234925&idtabungan="+idtabungan+"&nis="+nis+"&idtahunbuku="+idtahunbuku+"&jtarik="+jtarik+"&keterangan="+keterangan+"&rekkas="+rekkas;
		document.location.href = addr;
		//alert(addr);
		//document.getElementById('simpansetor').disabled = false;
	}
...
{	
	...
	var nis = document.getElementById('nis').value;
	var idtahunbuku = document.getElementById('idtahunbuku').value;
	var addr = "tabungan.trans.input.php?idtabungan="+idtabungan+"&nis="+nis+"&idtahunbuku="+idtahunbuku;	
...
function cetak() 
{
	...
	var nis = document.getElementById('nis').value;
	var idtahunbuku = document.getElementById('idtahunbuku').value;
	var addr = "tabungan.trans.cetak.php?idtabungan="+idtabungan+"&nis="+nis+"&idtahunbuku="+idtahunbuku+"&page="+pageList;
