function change_dep()
{
	parent.content.location.href = "laporan.pegawai.blank.php";
}
...
function show_pembayaran() {
	...
	if (validasi)
		parent.content.location.href = "laporan.pegawai.content.main.php?tanggal1="+tanggal1+"&tanggal2="+tanggal2+"&idtahunbuku="+idtahunbuku+"&departemen="+departemen;
