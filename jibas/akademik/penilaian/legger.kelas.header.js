function change_dept()
{
    ...
    document.location.href = "legger.kelas.header.php?departemen="+departemen;
    parent.footer.location.href = "legger.kelas.blank.php";
}
...
function change_ta()
{
    ...
    document.location.href = "legger.kelas.header.php?departemen="+departemen+"&tahunajaran="+tahunajaran;
    parent.footer.location.href = "legger.kelas.blank.php";
}
...
function change_tingkat()
{
    ...
    document.location.href = "legger.kelas.header.php?tingkat="+tingkat+"&departemen="+departemen+"&tahunajaran="+tahunajaran;
    parent.footer.location.href = "legger.kelas.blank.php";
}
...
function change_kelas()
{
    ...
    document.location.href = "legger.kelas.header.php?tingkat="+tingkat+"&kelas="+kelas+"&departemen="+departemen+"&tahunajaran="+tahunajaran;
    parent.footer.location.href = "legger.kelas.blank.php";
}
...
function change_semester()
{
    ...
    document.location.href = "legger.kelas.header.php?tingkat="+tingkat+"&kelas="+kelas+"&departemen="+departemen+"&tahunajaran="+tahunajaran+"&semester="+semester;
    parent.footer.location.href = "legger.kelas.blank.php";
}
...
function show()
{
    ...
    var page = "legger.kelas.content.php";
