...
showDataPegawai = function()
{
	...
	$.ajax({
		url: "presensikeg.rekapguru.ajax.php",
		data: "op=getpegawai&bulan="+bulan+"&tahun="+tahun+"&bagian="+bagian,
...
showReport = function(bulan, tahun, nip)
{
	parent.report.location.href = "presensikeg.rekapguru.report.php?bulan="+bulan+"&tahun="+tahun+"&nip="+nip;
}
...
doSearch = function()
{
	...
	$.ajax({
		url: "presensikeg.rekapguru.ajax.php",
		data: "op=searchpegawai&bulan="+bulan+"&tahun="+tahun+"&filter="+filter+"&keyword="+keyword,
		success: function(html) {
