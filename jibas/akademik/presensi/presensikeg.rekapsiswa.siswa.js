...
changeCbDepartemen = function()
{
	...
	$(function() {
		...
		// Get CbTingkat
		$.ajax({
			url: "presensikeg.rekapsiswa.ajax.php",
...
showDataSiswa = function()
{
	...
	$.ajax({
		url: "presensikeg.rekapsiswa.ajax.php",
		data: "op=getsiswa&bulan="+bulan+"&tahun="+tahun+"&idkelas="+idkelas,
		success: function(html) {
			$("#divSiswa").html(html);
		},
		error: function(xhr, options, error) {
...
showReport = function(bulan, tahun, nis)
{
	parent.report.location.href = "presensikeg.rekapsiswa.report.php?bulan="+bulan+"&tahun="+tahun+"&nis="+nis;
}
...
doSearch = function()
{
	...
	$.ajax({
		url: "presensikeg.rekapsiswa.ajax.php",
		data: "op=searchsiswa&bulan="+bulan+"&tahun="+tahun+"&filter="+filter+"&keyword="+keyword,
		success: function(html) {
			$("#divSiswa2").html(html);
		},
		error: function(xhr, options, error) {
