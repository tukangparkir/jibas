...
function ExcelRapor3()
{
    ...
    addr = 'infosiswa.rapor.excel.php?nis='+nis+'&nis_aktif='+nis_aktif+'&kelas='+kelas+'&semester='+semester;
    newWindow(addr, 'ExcelRapor', '800', '650', 'resizable=1,scrollbars=1,status=0,toolbar=0');
}
