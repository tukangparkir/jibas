...
Menurut laporan The New York Times, satu set earphone khusus itu akan dijual seharga 85 dollar AS, dan mulai dipasarkan pada akhir 2013.
...
Saat ini, perangkat kacamata pintar ";

$prev = PreviewText($text, 480);
