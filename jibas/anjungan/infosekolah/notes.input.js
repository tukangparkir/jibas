...
not_ValidateNotes = function() {
	...
	var dept = $.trim($not_jQueryParent("#ifse_departemen").val());
...
not_SaveNotes = function() {
	...
	formData.append("departemen", $not_jQueryParent("#ifse_departemen").val());
	...
	formData.append("pesan", ifse_ChangeNewLine($("#not_pesan").val()));
