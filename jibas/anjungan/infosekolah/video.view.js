...
vidvw_InitDialogBox = function() {
	...
	$vid_jQueryParent("#ifse_vidvw_DelCmt_Dialog").dialog({
        autoOpen: false,
        position: 'center',
		height: 220,
		width: 480,
        ...
        buttons: {
            ...
            'Batal': function() {
                $vid_jQueryParent("#ifse_vidvw_DelCmt_Dialog").dialog('close');
            }
        },
        close: function() {
	...
	$vid_jQueryParent("#ifse_vidvw_EditVideo_Dialog").dialog({
        autoOpen: false,
        position: 'center',
		height: 220,
		width: 480,
        ...
        buttons: {
            ...
            'Batal': function() {
                $vid_jQueryParent("#ifse_vidvw_EditVideo_Dialog").dialog('close');
            }
        },
        close: function() {
	...
	$vid_jQueryParent("#ifse_vidvw_DelVideo_Dialog").dialog({
        autoOpen: false,
        position: 'center',
		height: 220,
		width: 480,
        ...
        buttons: {
            ...
            'Batal': function() {
                $vid_jQueryParent("#ifse_vidvw_DelVideo_Dialog").dialog('close');
            }
        },
        close: function() {
...
vidvw_ShowDeleteVideoDialog = function(videoid) {
	...
	$.ajax({
		...
		success: function(html) {
			$vid_jQueryParent("#ifse_vidvw_DelVideo_Dialog").html(html);
			$vid_jQueryParent("#ifse_vidvw_DelVideo_Dialog").dialog('option', 'title', 'Hapus video');
			$vid_jQueryParent("#ifse_vidvw_DelVideo_Dialog").dialog('open');
		},
...
vidvw_ShowEditVideoDialog = function(videoid) {
	...
	$.ajax({
		...
		data: "videoid="+videoid,
		success: function(html) {
			$vid_jQueryParent("#ifse_vidvw_EditVideo_Dialog").html(html);
			$vid_jQueryParent("#ifse_vidvw_EditVideo_Dialog").dialog('option', 'title', 'Ubah video');
			$vid_jQueryParent("#ifse_vidvw_EditVideo_Dialog").dialog('open');
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(xhr.responseText);
        }
...
vidvw_ShowDeleteCommentDialog = function(replid, rowid) {
    ...
    $.ajax({
		...
		success: function(html) {
			$vid_jQueryParent("#ifse_vidvw_DelCmt_Dialog").html(html);
			$vid_jQueryParent("#ifse_vidvw_DelCmt_Dialog").dialog('option', 'title', 'Hapus Komentar');
			$vid_jQueryParent("#ifse_vidvw_DelCmt_Dialog").dialog('open');
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(xhr.responseText);
        }
...
vidvw_SaveComment = function() {
	...
	var dept = $vid_jQueryParent("#ifse_departemen").val();
