...
not_NotesView_InitDialogComment = function() {
	...
	$not_jQueryParent("#ifse_not_EditNotes_Dialog").dialog({
        autoOpen: false,
        position: 'center',
		height: 220,
		width: 480,
        ...
        buttons: {
            ...
            'Batal': function() {
                $not_jQueryParent("#ifse_not_EditNotes_Dialog").dialog('close');
            }
        },
        close: function() {
	...
	$not_jQueryParent("#ifse_not_DelNotes_Dialog").dialog({
        autoOpen: false,
        position: 'center',
		height: 220,
		width: 480,
        ...
        buttons: {
            ...
            'Batal': function() {
                $not_jQueryParent("#ifse_not_DelNotes_Dialog").dialog('close');
            }
        },
        close: function() {
    ...
    $not_jQueryParent("#ifse_not_DelCmt_Dialog").dialog({
        autoOpen: false,
        position: 'center',
		height: 220,
		width: 480,
        ...
        buttons: {
            ...
            'Batal': function() {
                $not_jQueryParent("#ifse_not_DelCmt_Dialog").dialog('close');
            }
        },
        close: function() {
...
not_SaveComment = function() {
	...
	var dept = $not_jQueryParent("#ifse_departemen").val();
...
not_ShowDeleteCommentDialog = function(replid, rowid) {
    ...
    $.ajax({
		...
		success: function(html) {
			$not_jQueryParent("#ifse_not_DelCmt_Dialog").html(html);
			$not_jQueryParent("#ifse_not_DelCmt_Dialog").dialog('option', 'title', 'Hapus Komentar');
			$not_jQueryParent("#ifse_not_DelCmt_Dialog").dialog('open');
		},
...
not_ShowEditNotesDialog = function(notesid) {
	...
	$.ajax({
		...
		data: "notesid="+notesid,
		success: function(html) {
			$not_jQueryParent("#ifse_not_EditNotes_Dialog").html(html);
			$not_jQueryParent("#ifse_not_EditNotes_Dialog").dialog('option', 'title', 'Ubah notes');
			$not_jQueryParent("#ifse_not_EditNotes_Dialog").dialog('open');
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(xhr.responseText);
        }
...
not_ShowDeleteNotesDialog = function(notesid) {
	...
	$.ajax({
		...
		data: "notesid="+notesid,
		success: function(html) {
			$not_jQueryParent("#ifse_not_DelNotes_Dialog").html(html);
			$not_jQueryParent("#ifse_not_DelNotes_Dialog").dialog('option', 'title', 'Hapus notes');
			$not_jQueryParent("#ifse_not_DelNotes_Dialog").dialog('open');
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(xhr.responseText);
        }
