...
vidinp_ValidateNotes = function() {
	...
	var dept = $.trim($vid_jQueryParent("#ifse_departemen").val());
...
vidinp_SaveGallery = function() {
	...
	formData.append("departemen", $vid_jQueryParent("#ifse_departemen").val());
	...
	formData.append("keterangan", ifse_ChangeNewLine($("#vidinp_pesan").val()));
