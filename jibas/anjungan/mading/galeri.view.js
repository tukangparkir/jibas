...
galvw_InitDialogBox = function() {
	...
	$gal_jQueryParent("#galvw_EditGallery_Dialog").dialog({
        autoOpen: false,
        position: 'center',
		height: 220,
		width: 480,
        ...
        buttons: {
            ...
            'Batal': function() {
                $gal_jQueryParent("#galvw_EditGallery_Dialog").dialog('close');
            }
        },
        close: function() {
    ...
    $gal_jQueryParent("#galvw_DelCmt_Dialog").dialog({
        autoOpen: false,
        position: 'center',
		height: 220,
		width: 480,
        ...
        buttons: {
            ...
            'Batal': function() {
                $gal_jQueryParent("#galvw_DelCmt_Dialog").dialog('close');
            }
        },
        close: function() {
	...
	$gal_jQueryParent("#galvw_DelGallery_Dialog").dialog({
        autoOpen: false,
        position: 'center',
		height: 220,
		width: 480,
        ...
        buttons: {
            ...
            'Batal': function() {
                $gal_jQueryParent("#galvw_DelGallery_Dialog").dialog('close');
            }
        },
        close: function() {
...
galvw_ShowDeleteGalleryDialog = function(galleryid) {
	...
	$.ajax({
		...
		success: function(html) {
			$gal_jQueryParent("#galvw_DelGallery_Dialog").html(html);
			$gal_jQueryParent("#galvw_DelGallery_Dialog").dialog('option', 'title', 'Hapus galeri');
			$gal_jQueryParent("#galvw_DelGallery_Dialog").dialog('open');
		},
...
galvw_ShowEditGalleryDialog = function(galleryid) {
	...
	$.ajax({
		...
		data: "galleryid="+galleryid,
		success: function(html) {
			$gal_jQueryParent("#galvw_EditGallery_Dialog").html(html);
			$gal_jQueryParent("#galvw_EditGallery_Dialog").dialog('option', 'title', 'Ubah galeri');
			$gal_jQueryParent("#galvw_EditGallery_Dialog").dialog('open');
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(xhr.responseText);
        }
...
galvw_SaveComment = function() {
	...
	var dept = $gal_jQueryParent("#mad_departemen").val();
...
galvw_ShowDeleteCommentDialog = function(replid, rowid) {
    ...
    $.ajax({
		...
		success: function(html) {
			$gal_jQueryParent("#galvw_DelCmt_Dialog").html(html);
			$gal_jQueryParent("#galvw_DelCmt_Dialog").dialog('option', 'title', 'Hapus Komentar');
			$gal_jQueryParent("#galvw_DelCmt_Dialog").dialog('open');
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(xhr.responseText);
        }
