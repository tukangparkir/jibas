...
galinp_ValidateNotes = function() {
	...
	var dept = $.trim($gal_jQueryParent("#mad_departemen").val());
...
galinp_SaveGallery = function() {
	...
	formData.append("departemen", $gal_jQueryParent("#mad_departemen").val());
	...
	formData.append("keterangan", mad_ChangeNewLine($("#galinp_pesan").val()));
