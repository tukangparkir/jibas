...
not_edit_SaveNotes = function() {
	...
	var isok = Validator.CheckLength($("#not_edit_judul"), "Judul Pesan", 5, 100) &&
			   Validator.CheckLength($("#not_edit_kepada"), "Tujuan Pesan", 5, 100) &&
	...
	formData.append("pesan", mad_ChangeNewLine($("#not_edit_pesan").val()));
